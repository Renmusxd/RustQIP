...
/// assert_eq!(p, 1.0);
/// ```
pub fn measure_prob<P: Precision>(n: u64, measured: u64, indices: &[u64], input: &[Complex<P>],
                                  input_offset: Option<u64>, multithread: bool) -> P {
...
pub fn measure_probs<P: Precision>(n: u64, indices: &[u64], input: &[Complex<P>], input_offset: Option<u64>, multithread: bool) -> Vec<P> {
...
pub fn measure_state<P: Precision>(n: u64, indices: &[u64], measured: (u64, P),
                                   input: &[Complex<P>], output: &mut[Complex<P>],
                                   offsets: Option<(u64, u64)>, multithread: bool) {
...
mod measurement_tests {
    ...
    fn test_measure_state() {
        ...
        approx_eq(&output, &from_reals(&[half.sqrt(), half.sqrt(), 0.0, 0.0]), 10);
    }
    ...
    fn test_measure_state2() {
        ...
        let half: f64 = 1.0 / 2.0;
        approx_eq(&output, &from_reals(&[0.0, 0.0, half.sqrt(), half.sqrt()]), 10);
    }
